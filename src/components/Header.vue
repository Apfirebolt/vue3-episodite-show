        ...
        <div class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
            <div class="relative flex items-center justify-between h-16">
                ...
                <div class="flex lg:hidden">
                    <!-- Mobile menu button -->
                    <DisclosureButton
                        class="bg-rose-500 inline-flex items-center justify-center p-2 rounded-md text-indigo-400 hover:text-white hover:bg-rose-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-red-600 focus:ring-white">
            ...
            <div class="px-2 pt-2 pb-3 space-y-1">
                <DisclosureButton v-for="item in navigation" :key="item.name" as="a" :href="item.href" :class="[
                    item.current
                        ...
                        : 'text-red-500 hover:text-gray-100 hover:bg-rose-500',
